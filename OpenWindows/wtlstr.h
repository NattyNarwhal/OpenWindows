...
#if !defined(__WTLSTR_H__) && !defined(__ATLMISC_H__) && !defined(__ATLSTR_H__) && !defined(__AFXSTR_H__)
...
inline CString::CString(LPCTSTR lpsz)
{
	...
	if (lpsz != NULL && HIWORD(lpsz) == NULL)
	{
		...
		if (!LoadString(nID))
			ATLTRACE(_T("Warning: implicit LoadString(%u) in CString failed\n"), nID);
	}
	else
	{
...
#endif // !defined(__WTLSTR_H__) && !defined(__ATLMISC_H__) && !defined(__ATLSTR_H__) && !defined(__AFXSTR_H__)
